...
osSemaphoreId_t PasswordHandle;
const osSemaphoreAttr_t Password_attributes = {
  .name = "Password"
};
/* USER CODE BEGIN PV */
...
void StartKeypad(void *argument);
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  PasswordHandle = osSemaphoreNew(1, 1, &Password_attributes);
  ...
  /* creation of Keypad */
  KeypadHandle = osThreadNew(StartKeypad, NULL, &Keypad_attributes);
...
/* USER CODE BEGIN Header_StartKeypad */
/**
* @brief Function implementing the Keypad thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartKeypad */
void StartKeypad(void *argument)
{
  /* USER CODE BEGIN StartKeypad */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END StartKeypad */
}
